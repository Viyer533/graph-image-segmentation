...
def generate_image(forest, width, height):
    ...
    return img.transpose(Image.Transpose.ROTATE_270).transpose(
        Image.Transpose.FLIP_LEFT_RIGHT
    )


def get_segmented_image(sigma, neighbor, K, min_comp_size, input_file, output_file):
    print("Input file for main.py function: ", input_file)
    print("Output file for main.py function: ", output_file)
    ...
    logger.info(
        "Image info: {} | {} | {}".format(image_file.format, size, image_file.mode)
    )
